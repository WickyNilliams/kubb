...
export abstract class OperationGenerator<TOptions = unknown> extends Generator<TOptions, Context<TOptions>> {
    ...
    const promises = Object.keys(filterdPaths).reduce(
      (acc, path) => {
        ...
        methods.forEach((method) => {
          ...
          const promise = this.#methods[method].call(this, operation, this.getSchemas(operation), options)
          if (promise) {
            acc.push(promise)
          }
        })
   ...
   * GET
   */
  abstract get(operation: Operation, schemas: OperationSchemas, options?: Partial<TOptions>): Promise<KubbFile.File | null>

  /**
   * POST
   */
  abstract post(operation: Operation, schemas: OperationSchemas, options?: Partial<TOptions>): Promise<KubbFile.File | null>
  /**
   * PATCH
   */
  abstract patch(operation: Operation, schemas: OperationSchemas, options?: Partial<TOptions>): Promise<KubbFile.File | null>

  /**
   * PUT
   */
  abstract put(operation: Operation, schemas: OperationSchemas, options?: Partial<TOptions>): Promise<KubbFile.File | null>

  /**
   * DELETE
   */
  abstract delete(operation: Operation, schemas: OperationSchemas, options?: Partial<TOptions>): Promise<KubbFile.File | null>
